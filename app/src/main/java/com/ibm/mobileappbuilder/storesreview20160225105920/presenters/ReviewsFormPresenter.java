...
public class ReviewsFormPresenter extends BaseFormPresenter<StoresDSItem> {

    private final CrudDatasource<StoresDSItem> datasource;

    public ReviewsFormPresenter(CrudDatasource<StoresDSItem> datasource, FormView<StoresDSItem> view){
        super(view);
