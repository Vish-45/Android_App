...
/**
 * "GhostSightingsFragment" listing
 */
public class GhostSightingsFragment extends ibmmobileappbuilder.maps.ui.MapFragment<StoresDSItem> {
    private SearchBehavior searchBehavior;
    private Datasource<StoresDSItem> datasource;
    private SearchOptions searchOptions;

    public static GhostSightingsFragment newInstance(Bundle args){
        GhostSightingsFragment fr = new GhostSightingsFragment();
    ...
    public void navigateToDetail(StoresDSItem item) {
        ...
        new StartActivityAction(GhostSightingsDetailActivity.class, bundle).execute(getActivity());
    }
}
