...
import com.ibm.mobileappbuilder.storesreview20160225105920.presenters.ReviewsDetailPresenter;
...
public class ReviewsDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<StoresDSItem> implements ShareBehavior.ShareListener  {
    ...
    public void bindView(final StoresDSItem item, View view) {
        ...
        if (item.sightingDetailsWebsites != null){
            ...
            view4.setText(item.sightingDetailsWebsites);
    ...
    public void onShare() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, (item.rating != null ? item.rating.toString() + "★" : "" ) + "\n" +
