...
import com.ibm.mobileappbuilder.storesreview20160225105920.presenters.ReviewsPresenter;
    ...
    */
    ...
    protected void bindView(StoresDSItem item, View view, int position) {
        ...
        if (item.nameOfThePlace != null){
            title.setText(item.nameOfThePlace);
        ...
        if (item.reviewDate != null){
            subtitle.setText("Last reviewed on " + DateFormat.getMediumDateFormat(getActivity()).format(item.reviewDate));
